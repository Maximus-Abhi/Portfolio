...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "snake language slithering through data, no cap! 🐍💻",
    color: "#3776ab",
  ...
  [SkillNames.NUMPY]: {
    ...
    name: "numpy",
    label: "NumPy",
    shortDescription: "array manipulation go brrr! 🔢✨",
    color: "#013243",
  ...
  [SkillNames.TENSORFLOW]: {
    ...
    name: "tensorflow",
    label: "TensorFlow",
    shortDescription: "neural nets hitting different! 🧠🔥",
    color: "#ff6f00",
  ...
  [SkillNames.PYTORCH]: {
    ...
    name: "pytorch",
    label: "PyTorch",
    shortDescription: "the deep learning framework, no cap! 🤖🔥",
    color: "#ff6f00",
  ...
  [SkillNames.SCIKIT_LEARN]: {
    ...
    name: "scikit-learn",
    label: "Scikit-learn",
    shortDescription: "the machine learning framework, no cap! 🤖🔥",
    color: "#ff6f00",
  ...
  [SkillNames.PANDAS]: {
    ...
    name: "pandas",
    label: "Pandas",
    shortDescription: "data wrangling like a boss! 🐼📈",
    color: "#ff6f00",
