...
const PROJECTS = [
  {
    id: 1,
    name: "My Portfolio",
    description: `This is my portfolio website that I built using Next.js, Tailwind CSS, and TypeScript.`,
    link: "https://www.abhishekvishwakarma.com/",
    images: ["/assets/projects-screenshots/portfolio/1.png"],
  },
  {
    id: 2,
    name: "Coupon Luxury",
